...
/**
 * The split-panel chrome every signed-out screen shares -- sign in, forgot
 * password, set password. Keeping it in one place means the recovery flow
 * doesn't drift into looking like a different product halfway through.
 */
